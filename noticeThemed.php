...
?>
		<br />
		<!--<a href="/<?php echo $xslNoticesOfflineUrl; ?>" target="_blank" style="font-size: 12px;">XSLT utilisée</a>-->
<?php
		/*$xsl = new DOMDocument;
		$xsl->load($xslNoticesOfflineUrl);
		...
		<pre class="prettyprint linenums">
			<code class="language-xml"><?php echo $xml->saveXML(); ?></code>
		</pre>
		<?php
