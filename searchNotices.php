<?php
	...
	$url = $ini_array["CatalogueWebServiceUrl"]."search/notices"."?criters=".urlencode($xmlAdvancedSearchCriterias->asXML());
	...
	else if(null != $defaultBasicSearchCriterias)
	{
		...
		$url = $ini_array["CatalogueWebServiceUrl"]."search/notices"."?criters=".urlencode($xmlSearchCriterias->asXML());
	}
